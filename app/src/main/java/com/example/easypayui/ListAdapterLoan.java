...
public class ListAdapterLoan extends ArrayAdapter<String> {
    ...
    public ListAdapterLoan(Context context, ArrayList<String> dataItem) {
        super(context, R.layout.child_listview_loan, dataItem);
        this.data = dataItem;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.child_listview_loan, null);
            viewHolder = new ViewHolder();
            viewHolder.text = (TextView) convertView
                    .findViewById(R.id.childTextViewConf);
            viewHolder.buttonSent = (Button) convertView
                    .findViewById(R.id.btnLoanIt);
