...
public class ConfirmationContactActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmation_contact);
        ...
        adapterXConf = new ListAdapterConfirmation(ConfirmationContactActivity.this, dataItemsConf);
        adapterXConf.setCustomButtonListner( ConfirmationContactActivity.this);

        listViewXConf.setAdapter(adapterXConf);
    }

    public void onButtonClickListner(int position , String value) {
        Toast.makeText(ConfirmationContactActivity.this, "Button click " + value,
