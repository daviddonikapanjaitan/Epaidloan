...
public class ListRequestActivity extends AppCompatActivity implements
        ListAdapterRequestBuddies.customButtonListener{

    ListView listViewX;
    ListAdapterRequestBuddies adapterX;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterX = new ListAdapterRequestBuddies(ListRequestActivity.this, dataItems);
        adapterX.setCustomButtonListner(ListRequestActivity.this);
    ...
    public void onButtonClickListner(int position, String value) {
        Toast.makeText(ListRequestActivity.this, "Button click " + value,
