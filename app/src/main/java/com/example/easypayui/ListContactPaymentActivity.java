...
public class ListContactPaymentActivity extends AppCompatActivity implements
        ListAdapterSentMoney.customButtonListener {

    ListView listViewX;
    ListAdapterSentMoney adapterX;
    ArrayList<String> dataItems = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_contact_payment);
        ...
        adapterX = new ListAdapterSentMoney(ListContactPaymentActivity.this, dataItems);
        adapterX.setCustomButtonListner(ListContactPaymentActivity.this);

        listViewX.setAdapter(adapterX);
    }

    public void onButtonClickListner(int position , String value) {
        Toast.makeText(ListContactPaymentActivity.this, "Button click " + value,
                Toast.LENGTH_SHORT).show();
        if(position == 1){
            Intent x = new Intent(getApplicationContext(), PinSentActivity.class);
            startActivity(x);
        }
    }
}
